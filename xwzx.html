...
<head>
  ...
  <link href="static/prevsf/10185/10185258/css/738144_Pc_zh-CN.css" rel="stylesheet" />
  ...
  <script type='text/javascript' id='jqueryzoom' src='static/Designer/Scripts/jquery.jqueryzoom.js'></script>
...
<body id="smart-body" area="main">
  <input type="hidden" id="pageinfo" value="738144" data-type="1" data-device="Pc" data-entityid="738144" />
      ...
      <div class="main-layout" id="tem-main-layout11" style="width: 100%;">
        ...
        <div class="" id="smv_MainContent" rel="mainContentWrapper" style="width: 100%; min-height: 300px; position: relative; ">
          <div class="smvWrapper" style="min-width:1000px;  position: relative; background-color: transparent; background-image: none; background-repeat: no-repeat; background:-moz-linear-gradient(top, none, none);background:-webkit-gradient(linear, left top, left bottom, from(none), to(none));background:-o-linear-gradient(top, none, none);background:-ms-linear-gradient(top, none, none);background:linear-gradient(top, none, none);;background-position:0 0;background-size:auto;" bgScroll="none">
            <div class="smvContainer" id="smv_Main" cpid="738144" style="min-height:400px;width:1000px;height:1208px;  position: relative; ">
              <div id="smv_con_117_48" ctype="slideset" class="esmartMargin smartAbs " cpid="738144" cstyle="Style1" ccolor="Item0" areaId="Main" isContainer="True" pvid="" tareaId="Main" re-direction="y" daxis="Y" isdeletable="True" style="height: 614px; width: 1200px; left: 0px; top: -105px;z-index:0;">
                <div class="yibuFrameContent con_117_48  slideset_Style1  " style="overflow:visible;;">
                  <!--w-slide-->
                  <div class="w-slide" id="slider_smv_con_117_48">
                    <div class="w-slide-inner" data-u="slides">
                      <div class="content-box" data-area="Area1">
                        <div id="smc_Area1" cid="con_117_48" class="smAreaC slideset_AreaC">
                          <div id="smv_con_119_48" ctype="text" smanim='{"delay":0.0,"duration":0.75,"direction":"Left","animationName":"slideIn","infinite":"1"}' class="esmartMargin smartAbs animated" cpid="738144" cstyle="Style1" ccolor="Item2" areaId="Area1" isContainer="False" pvid="con_117_48" tareaId="" re-direction="all" daxis="All" isdeletable="True" style="height: 120px; width: 360px; left: 430px; top: 250px;z-index:3;">
                            <div class="yibuFrameContent con_119_48  text_Style1  " style="overflow:hidden;;">
                              <div id='txt_con_119_48' style="height: 100%;">
                                <div class="editableContent" id="txtc_con_119_48" style="height: 100%; word-wrap:break-word;">
                                  <p style="text-align:center"><span style="font-size:48px"><span style="color:#ffffff"><strong><span style="line-height:2">新闻资讯</span></strong>
                                      </span>
                                    </span>
                                  </p>
                                  <p style="text-align:center"><span style="font-size:22px"><strong><span style="color:#ffffff">News information</span></strong>
                                    </span>
                                  </p>
                                </div>
                              </div>
                              <script>
                              var tables = $(' #smv_con_119_48').find('table')
                    ...
                    <!-- 1Arrow Navigator -->
                    <span data-u="arrowleft" class="w-slide-arrowl  slideArrow  f-hide  " data-autocenter="2" id="left_con_117_48">
                      <i class="w-itemicon mw-iconfont">&#xb133;</i>
                    </span>
                    <span data-u="arrowright" class="w-slide-arrowr slideArrow  f-hide " data-autocenter="2" id="right_con_117_48">
                  ...
                  <script type="text/javascript">
                  con_117_48_page = 1;
                  con_117_48_sliderset3_init = function() {
                    var jssor_1_options_con_117_48 = {
                    ...
                    //初始化幻灯
                    var slide = new $JssorSlider$("slider_smv_con_117_48", jssor_1_options_con_117_48);
                    $('#smv_con_117_48').data('jssor_slide', slide);

                    //resize游览器的时候触发自动缩放幻灯秀
                    $(window).bind("resize", function(e) {
                      if (e.target == this) {
                        var $this = $('#slider_smv_con_117_48');
                        var ww = $(window).width();
                    ...
                    slide.$On($JssorSlider$.$EVT_PARK, function(slideIndex, fromIndex) {
                      var $slideWrapper = $("#slider_smv_con_117_48 .w-slide-inner:last");
                      var $fromSlide = $slideWrapper.find(".content-box:eq(" + fromIndex + ")");
                      var $curSlide = $slideWrapper.find(".content-box:eq(" + slideIndex + ")");
                      var $nextSlide = $slideWrapper.find(".content-box:eq(" + (slideIndex + 1) + ")");
                      $("#smv_con_117_48").attr("selectArea", $curSlide.attr("data-area"));
                      $fromSlide.find(".animated").smanimate("stop");
                      $curSlide.find(".animated").smanimate("stop");
                      $nextSlide.find(".animated").smanimate("stop");
                      $("#switch_con_117_48 .page").html(slideIndex + 1);
                      $curSlide.find(".animated").smanimate("replay");
                      return false;
                    });
                    //切换栏点击事件
                    $("#switch_con_117_48 .left").unbind("click").click(function() {
                      if (con_117_48_page == 1) {
                        con_117_48_page = 1;
                      } else {
                        con_117_48_page = con_117_48_page - 1;
                      }
                      $("#switch_con_117_48 .page").html(con_117_48_page);
                      slide.$Prev();
                      return false;
                    });
                    $("#switch_con_117_48 .right").unbind("click").click(function() {
                      if (con_117_48_page == 1) {
                        con_117_48_page = 1;
                      } else {
                        con_117_48_page = con_117_48_page + 1;
                  ...
                  $(function() {
                    ...
                    con_117_48_sliderset3_init();

                    var areaId = $("#smv_con_117_48").attr("tareaid");
                    if (areaId == "") {
                      var mainWidth = $("#smv_Main").width();
                      $("#smv_con_117_48 .slideset_AreaC").css({
                        "width": mainWidth + "px",
                        "position": "relative",
                        "margin": "0 auto"
                      });
                    } else {
                      var controlWidth = $("#smv_con_117_48").width();
                      $("#smv_con_117_48 .slideset_AreaC").css({
                    ...
                    $("#smv_con_117_48").attr("selectArea", "Area1");

                    var arrowHeight = $('#slider_smv_con_117_48 .w-slide-arrowl').eq(-1).outerHeight();
                    var arrowTop = (18 - arrowHeight) / 2;
                    $('#slider_smv_con_117_48 .w-slide-arrowl').eq(-1).css('top', arrowTop);
                    $('#slider_smv_con_117_48 .w-slide-arrowr').eq(-1).css('top', arrowTop);
                  });
                  </script>
                </div>
              </div>
              <div id="smv_con_120_48" ctype="listnews" class="esmartMargin smartAbs " cpid="738144" cstyle="Style4" ccolor="Item0" areaId="" isContainer="False" pvid="" tareaId="" re-direction="all" daxis="All" isdeletable="True" style="height: 300px; width: 963px; left: 9px; top: 613px;z-index:10035;">
                <div class="yibuFrameContent con_120_48  listnews_Style4  " style="overflow:visible;;">
                  <div class="w-list xn-resize">
                    <ul class="w-list-ul " id="ulList_con_120_48" data-title-autolines="1" data-desc-autolines="2">
                      <li class="w-list-item f-clearfix">
                        <div class="w-list-pic">
                          <a href="/news.php?id=2182826" target="_self" class="w-list-piclink">
                            <img class="w-listpic-in" src="static/contents/sitefiles2037/10185258/images/13450497.jpeg" />
                          </a>
                        </div>
                        <div class="w-list-r">
                          <div class="w-list-r-in">
                            <h3 class="w-list-title">
                              <a href="/news.php?id=2182826" target="_self" class="w-list-titlelink">第四届宁波国际微电影节入围作品名单！</a>
                            </h3>
                            <p class="w-list-desc "></p>
                            <div class="w-list-bottom clearfix ">
                              <span class="w-list-viewnum "><i class="w-list-viewicon mw-iconfont">&#xb136;</i><span class="AR" data-dt="nvc" data-v="2182826">5</span></span>
                      ...
                      <li class="w-list-item f-clearfix">
                        <div class="w-list-pic">
                          <a href="/news.php?id=2165080" target="_self" class="w-list-piclink">
                            <img class="w-listpic-in" src="static/contents/sitefiles2037/10185258/images/13184711.jpg" />
                          </a>
                        </div>
                        <div class="w-list-r">
                          <div class="w-list-r-in">
                            <h3 class="w-list-title">
                              <a href="/news.php?id=2165080" target="_self" class="w-list-titlelink">我团队参与后期制作的影片《一个人的城市》上映</a>
                            </h3>
                            <p class="w-list-desc "></p>
                            <div class="w-list-bottom clearfix ">
                              <span class="w-list-viewnum "><i class="w-list-viewicon mw-iconfont">&#xb136;</i><span class="AR" data-dt="nvc" data-v="2165080">3</span></span>
                              <span class="w-list-date ">2020-03-03</span>
                            </div>
                          </div>
                        </div>
                      </li>
                      <li class="w-list-item f-clearfix">
                        <div class="w-list-pic">
                          <a href="/news.php?id=2163185" target="_self" class="w-list-piclink">
                            <img class="w-listpic-in" src="static/contents/sitefiles2037/10185258/images/13314248.jpeg" />
                          </a>
                        </div>
                        <div class="w-list-r">
                          <div class="w-list-r-in">
                            <h3 class="w-list-title">
                              <a href="/news.php?id=2163185" target="_self" class="w-list-titlelink">Waves 发布适合 VR 的 360&#176; Ambisonics Tools 插件套装.</a>
                            </h3>
                            <p class="w-list-desc ">Waves&nbsp;发布适合&nbsp;VR&nbsp;的&nbsp;360°&nbsp;Ambisonics&nbsp;Tools&nbsp;插件套装.</p>
                            <div class="w-list-bottom clearfix ">
                              <span class="w-list-viewnum "><i class="w-list-viewicon mw-iconfont">&#xb136;</i><span class="AR" data-dt="nvc" data-v="2163185">3</span></span>
                              <span class="w-list-date ">2020-03-03</span>
                            </div>
                          </div>
                        </div>
                      ...
                      <li class="w-list-item f-clearfix">
                        <div class="w-list-pic">
                          <a href="/news.php?id=2137957" target="_self" class="w-list-piclink">
                            <img class="w-listpic-in" src="static/contents/sitefiles2037/10185258/images/13325613.jpg" />
                          </a>
                        </div>
                        <div class="w-list-r">
                          <div class="w-list-r-in">
                            <h3 class="w-list-title">
                              <a href="/news.php?id=2137957" target="_self" class="w-list-titlelink">我团队参加2018年俄罗斯世界杯腾讯体育《巨星来了》网络转播</a>
                            </h3>
                            <p class="w-list-desc "></p>
                            <div class="w-list-bottom clearfix ">
                              <span class="w-list-viewnum "><i class="w-list-viewicon mw-iconfont">&#xb136;</i><span class="AR" data-dt="nvc" data-v="2137957">1</span></span>
                              <span class="w-list-date ">2018-06-16</span>
                            </div>
                          </div>
                        </div>
                      </li>
                      <li class="w-list-item f-clearfix">
                        <div class="w-list-pic"> <a href="/news.php?id=2135291" target="_self" class="w-list-piclink"> <img class="w-listpic-in" src="static/contents/sitefiles2037/10185258/images/13325784.bmp" autofill="ok" init="ok" style="width: auto; height: 88px; margin-left: -20.2222px;"> </a> </div>
                        <div class="w-list-r">
                          <div class="w-list-r-in">
                            <h3 class="w-list-title"> <a href="/news.php?id=2135291" target="_self" class="w-list-titlelink" style="max-height: 24px;">动画短片《平安夜》获学院奖</a> </h3>
                            <p class="w-list-desc " style="max-height: 36px;"></p>
                            <div class="w-list-bottom clearfix "> <span class="w-list-viewnum "><i class="w-list-viewicon mw-iconfont">넶</i>6</span> <span class="w-list-date ">2009-12-24</span> </div>
                          </div>
                        </div>
                      </li>
                    </ul>
                  ...
                  <script>
                    var callback_con_120_48 = function() {
                                            var sv = $("#smv_con_120_48");
                  ...
                  <script type="text/template" id="listTemplate_con_120_48">
                    <li class="w-list-item f-clearfix">
                                            <div class="w-list-pic">
              ...
              <div id="smv_con_107_54" ctype="line" class="esmartMargin smartAbs " cpid="738144" cstyle="Style2" ccolor="Item3" areaId="" isContainer="False" pvid="" tareaId="" re-direction="y" daxis="All" isdeletable="True" style="height: 20px; width: 20px; left: 9px; top: 562px;z-index:10034;">
              ...
              <div id="smv_con_105_14" ctype="text" class="esmartMargin smartAbs " cpid="738144" cstyle="Style1" ccolor="Item0" areaId="" isContainer="False" pvid="" tareaId="" re-direction="all" daxis="All" isdeletable="True" style="height: 23px; width: 360px; left: 36px; top: 562px;z-index:10032;">
                <div class="yibuFrameContent con_105_14  text_Style1  " style="overflow:hidden;;">
                  <div id='txt_con_105_14' style="height: 100%;">
                    <div class="editableContent" id="txtc_con_105_14" style="height: 100%; word-wrap:break-word;">
                      <p><span style="color:#4e5f70"><strong><span style="font-size:16px"><span style="font-family:Microsoft YaHei">热门推荐</span></span>
                          </strong>
                        </span>
                      </p>
                    </div>
          ...
          </div><input type='hidden' name='__RequestVerificationToken' id='token__RequestVerificationToken' value='RI5XkXor4N605NH44EvF3DHzm_TszQewmgk3Ii1CuYjiqFJ3zRBYV9d8hQiH2A5GJcJGZoF5VuYHmQ4b3pecwwMtZTvfwphBS3F10iP9t2j4EbKiUIxgLh0cZtzANAG-0' />
        </div>
      </div>
    </div>
    <div style="background-color: transparent; background-image: none; background-repeat: no-repeat;background-position:0 0; background:-moz-linear-gradient(top, none, none);background:-webkit-gradient(linear, left top, left bottom, from(none), to(none));background:-o-linear-gradient(top, none, none);background:-ms-linear-gradient(top, none, none);background:linear-gradient(top, none, none);;
