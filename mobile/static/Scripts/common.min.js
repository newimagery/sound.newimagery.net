...
$(document).ready(function() {
    $("div[ctype=listnews],div[ctype=listnewscategory]").click(function() {
        ...
        if (dataSource.length > 0) {
            ...
            $.cookie("newsIds", newsIds.replace(new RegExp(",", "g"), "."), {
                path: '/'
            });
            $.cookie("orderbyfield", orderbyfield, {
                path: '/'
            });
            $.cookie("orderbytype", orderbytype, {
                path: '/'
            });
            $.cookie("newsCategory", newsCategory.replace(new RegExp(",", "g"), "."), {
                path: '/'
            });
        } else { //没找到分页说明是滚动列表
            var arr = [];
