...
<head>
  ...
  <meta name="description" content="新闻资讯-意象音频" />
  <meta name="keywords" content="新闻资讯-意象音频" />
  <meta name="applicable-device" content="mobile" />
  <meta http-equiv="Cache-Control" content="no-transform" />
  <title>新闻资讯-意象音频</title>
  ...
  <link href="static/prevsf/10185/10185258/css/738144_Mobile_zh-CN.css" rel="stylesheet" />
  ...
  <script type='text/javascript' id='jqPaginator' src='static/Scripts/statics/js/jqPaginator.min.js?_version=20210414103602'></script>
  <script type="text/javascript">
  $.ajaxSetup({
    cache: false,
...
<body style="overflow-x: hidden;">
  <input type="hidden" id="pageinfo" value="738144" data-type="1" data-device="Mobile" data-entityid="738144" />
    ...
    <div class="main-layout-wrapper" id="smv_AreaMainWrapper" style="background-color: transparent; background-image: none;
      ...
      <div class="main-layout" id="tem-main-layout11" style="width: 100%;">
        ...
        <div class="" id="smv_MainContent" rel="mainContentWrapper" style="width: 100%; min-height: 300px; position: relative; ">
          <div class="smvContainer" id="smv_Main" cpid="738144" style="width: 100%;height:650px;  position: relative; background-color: transparent; background-image:none;background-repeat:no-repeat; background:-moz-linear-gradient(top, none, none);background:-webkit-gradient(linear, left top, left bottom, from(none), to(none));background:-o-linear-gradient(top, none, none);background:-ms-linear-gradient(top, none, none);background:linear-gradient(top, none, none);;background-position:0 0;background-size:auto" bgScroll="none">
            <div id="smv_con_35_56" ctype="slideset" class="esmartMargin smartAbs " cpid="738144" cstyle="Style1" ccolor="Item0" areaId="Main" isContainer="True" pvid="" tareaId="Main" re-direction="y" daxis="Y" isdeletable="True" style="height: 119px; width: 100%; left: 0px; top: -65px;z-index:0;">
              <div class="yibuFrameContent con_35_56  slideset_Style1 yibuFullScreen " style="overflow:visible;margin:0 0px;">
                <!--w-slide-->
                <div class="m-slide" id="slider_smv_con_35_56">
                  <div class="m-slide-inner" data-u="slides">
                    <div class="content-box" data-area="Area1">
                      <div id="smc_Area1" cid="con_35_56" class="smAreaC slideset_AreaC">
                        <div id="smv_con_2_33" ctype="text" smanim='{"delay":0.75,"duration":0.75,"direction":"Left","animationName":"slideIn","infinite":"1"}' class="esmartMargin smartAbs animated" cpid="738144" cstyle="Style1" ccolor="Item2" areaId="Area1" isContainer="False" pvid="con_35_56" tareaId="" re-direction="all" daxis="All" isdeletable="True" style="height: 65px; width: 200px; left: 56px; top: 38px;z-index:3;">
                          <div class="yibuFrameContent con_2_33  text_Style1  " style="overflow:hidden;;">
                            <div id='txt_con_2_33'>
                              <div class="editableContent" id="txtc_con_2_33" style="height: 100%;word-wrap:break-word;">
                                <p style="text-align:center"><span style="line-height:1.2"><span style="color:#ffffff"><span style="font-size:30px"><strong>新闻资讯</strong></span></span>
                                  </span>
                                </p>
                                <p style="text-align:center"><span style="line-height:1.2"><span style="font-size:16px"><span style="color:#ffffff">News information</span></span>
                                  </span>
                                </p>
                              </div>
                            </div>
                ...
                con_35_56_firstTime = true;
                con_35_56_sliderset3_init = function() {
                  var jssor_1_options_con_35_56 = {
                  ...
                  //初始化幻灯
                  var slide = new $JssorSlider$("slider_smv_con_35_56", jssor_1_options_con_35_56);
                  $('#smv_con_35_56').data('jssor_slide', slide);

                  //幻灯栏目自动或手动切换时触发的事件
                  slide.$On($JssorSlider$.$EVT_PARK, function(slideIndex, fromIndex) {
                    var $slideWrapper = $("#slider_smv_con_35_56 .m-slide-inner:last");
                    var $fromSlide = $slideWrapper.find(".content-box:eq(" + fromIndex + ")");
                    var $curSlide = $slideWrapper.find(".content-box:eq(" + slideIndex + ")");

                    $("#smv_con_35_56").attr("selectArea", $curSlide.attr("data-area"));
                    $fromSlide.find(".animated").smanimate("stop");
                    $curSlide.find(".animated").smanimate("stop");
                    $("#switch_con_35_56 .page").html(slideIndex + 1);

                    $curSlide.find(".animated").smanimate("replay");
                    return false;
                  });
                  //切换栏点击事件
                  $("#switch_con_35_56 .left").unbind("click").click(function() {
                    if (con_35_56_page == 1) {
                      con_35_56_page = 1;
                    } else {
                      con_35_56_page = con_35_56_page - 1;
                    }
                    $("#switch_con_35_56 .page").html(con_35_56_page);
                    slide.$Prev();
                  });
                  $("#switch_con_35_56 .right").unbind("click").click(function() {
                    if (con_35_56_page == 1) {
                      con_35_56_page = 1;
                    } else {
                      con_35_56_page = con_35_56_page + 1;
                ...
                $(function() {
                  con_35_56_sliderset3_init();
                  var areaId = $("#smv_con_35_56").attr("tareaid");
                  if (areaId == "") {
                    var mainWidth = $("#smv_Main").width();
                    $("#smv_con_35_56 .slideset_AreaC").css({
                      "width": mainWidth + "px",
                      "position": "relative",
                      "margin": "0 auto"
                    });
                  } else {
                    var controlWidth = $("#smv_con_35_56").width();
                    $("#smv_con_35_56 .slideset_AreaC").css({
                  ...
                  $("#smv_con_35_56").attr("selectArea", "Area1");

                  var arrowHeight = $('#slider_smv_con_35_56 .m-slide-arrowl').outerHeight();
                  var boxHeight = parseInt("117");
                  var arrowTop = (boxHeight - arrowHeight) / 2;
                  $('#slider_smv_con_35_56 .m-slide-arrowl').css('top', arrowTop).parent().css('top', 0);
                  $('#slider_smv_con_35_56 .m-slide-arrowr').css('top', arrowTop).parent().css('top', 0);
                });
                </script>
              </div>
            </div>
            <div id="smv_con_37_49" ctype="listnews" class="esmartMargin smartAbs " cpid="738144" cstyle="Style1" ccolor="Item0" areaId="" isContainer="False" pvid="" tareaId="" re-direction="y" daxis="All" isdeletable="True" style="height: 295px; width: 100%; left: 0px; top: 92px;z-index:18;">
              <div class="yibuFrameContent con_37_49  listnews_Style1 yibuFullScreen " style="overflow:visible;margin:0 0px;">
                <div class="mw-list xn-resize">
                  <ul class="mw-list-ul xn-resize    mw-list-numno" id="ulList_con_37_49">
                    <li class="mw-list-item f-clearfix">
                      <a href="/mobile/news.php?id=2182826" target="_self" class="mw-list-link">
                        <div class="mw-list-pic"><img src="static/contents/sitefiles2037/10185258/images/13450497.jpeg" /></div>
                        <div class="mw-list-r">
                          <div class="mw-list-r-in">
                            <h3 class="mw-list-title">第四届宁波国际微电影节入围作品名单！</h3>
                            <p class="mw-list-desc"></p>
                            <div class="mw-list-bottom f-clearfix">
                              <span class="mw-list-viewnum"><i class="mw-iconfont">&#xb136;</i><span class="AR" data-dt="nvc" data-v="2182826">52</span></span>
                              <span class="mw-list-date">2020-03-09</span>
                            </div>
                          </div>
                        </div>
                      </a>
                    ...
                    <li class="mw-list-item f-clearfix">
                      <a href="/mobile/news.php?id=2165080" target="_self" class="mw-list-link">
                        <div class="mw-list-pic"><img src="static/contents/sitefiles2037/10185258/images/13184711.jpg" /></div>
                        <div class="mw-list-r">
                          <div class="mw-list-r-in">
                            <h3 class="mw-list-title">我团队参与后期制作的影片《一个人的城市》上映</h3>
                            <p class="mw-list-desc"></p>
                            <div class="mw-list-bottom f-clearfix">
                              <span class="mw-list-viewnum"><i class="mw-iconfont">&#xb136;</i><span class="AR" data-dt="nvc" data-v="2165080">6</span></span>
                              <span class="mw-list-date">2020-03-03</span>
                            </div>
                          </div>
                        </div>
                      </a>
                    ...
                    <li class="mw-list-item f-clearfix">
                      <a href="/mobile/news.php?id=2163185" target="_self" class="mw-list-link">
                        <div class="mw-list-pic"><img src="static/contents/sitefiles2037/10185258/images/13314248.jpeg" /></div>
                        <div class="mw-list-r">
                          <div class="mw-list-r-in">
                            <h3 class="mw-list-title">Waves 发布适合 VR 的 360&#176; Ambisonics Tools 插件套装.</h3>
                            <p class="mw-list-desc">Waves&nbsp;发布适合&nbsp;VR&nbsp;的&nbsp;360°&nbsp;Ambisonics&nbsp;Tools&nbsp;插件套装.</p>
                            <div class="mw-list-bottom f-clearfix">
                              <span class="mw-list-viewnum"><i class="mw-iconfont">&#xb136;</i><span class="AR" data-dt="nvc" data-v="2163185">8</span></span>
                              <span class="mw-list-date">2020-03-03</span>
                            </div>
                          </div>
                        </div>
                    ...
                    <li class="mw-list-item f-clearfix">
                        <a href="/mobile/news.php?id=2137957" target="_self" class="mw-list-link">
                        <div class="mw-list-pic"><img src="static/contents/sitefiles2037/10185258/images/13325613.jpg" autofill="ok" init="ok" style="width: auto; height: 88px; margin-left: -14.7432px;"></div>
                        <div class="mw-list-r">
                          <div class="mw-list-r-in">
                            <h3 class="mw-list-title">我团队参加2018年俄罗斯世界杯腾讯体育《巨星来了》网络转播</h3>
                            <p class="mw-list-desc" style="max-height: 38px;"></p>
                            <div class="mw-list-bottom f-clearfix"> <span class="mw-list-viewnum"><i class="mw-iconfont">넶</i>14</span> <span class="mw-list-date">2018-06-16</span> </div>
                          </div>
                        </div>
                      </a> </li>
                    <li class="mw-list-item f-clearfix"> 
                        <a href="/mobile/news.php?id=2135291" target="_self" class="mw-list-link">
                        <div class="mw-list-pic"><img src="static/contents/sitefiles2037/10185258/images/13325784.bmp" autofill="ok" init="ok" style="width: auto; height: 88px; margin-left: -34.2222px;"></div>
                        <div class="mw-list-r">
                          <div class="mw-list-r-in">
                            <h3 class="mw-list-title">动画短片《平安夜》获学院奖</h3>
                            <p class="mw-list-desc" style="max-height: 38px;"></p>
                            <div class="mw-list-bottom f-clearfix"> <span class="mw-list-viewnum"><i class="mw-iconfont">넶</i>6</span> <span class="mw-list-date">2009-12-24</span> </div>
                          </div>
                        </div>
                      </a> </li>
                  </ul>
                ...
                <script>
                  var callback_con_37_49 = function() {
                                        var sv = $("#smv_con_37_49");
                                        var desc_line_height = sv.find(".mw-list .mw-list-ul .mw-list-item .mw-list-link .mw-list-desc").css("line-height");
                                        sv.find(".mw-list .mw-list-ul .mw-list-item .mw-list-link .mw-list-desc").css("max-height", parseInt(desc_line_height) * 2);
                ...
                <script type="text/template" id="listTemplate_con_37_49">
                  <li class="mw-list-item f-clearfix">
                                        <a href="$data.LinkUrl" target="_self" class="mw-list-link">
                                            ...
                                            <div class="mw-list-r">
                                                <div class="mw-list-r-in">
                                                    ...
                                                    <p class="mw-list-desc">$data.Short</p>
                                                    <div class="mw-list-bottom f-clearfix">
                                                        <span class="mw-list-viewnum"><i class="mw-iconfont">&#xb136;</i>$data.Hits</span>
                                                        <span class="mw-list-date">$data.QTime</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </a>
            ...
            <div id="smv_con_10_22" ctype="text" class="esmartMargin smartAbs " cpid="738144" cstyle="Style1" ccolor="Item2" areaId="" isContainer="False" pvid="" tareaId="" re-direction="all" daxis="All" isdeletable="True" style="height: 23px; width: 72px; left: 31px; top: 61px;z-index:3;">
              <div class="yibuFrameContent con_10_22  text_Style1  " style="overflow:hidden;;">
                <div id='txt_con_10_22'>
                  <div class="editableContent" id="txtc_con_10_22" style="height: 100%;word-wrap:break-word;">
                    <p><span style="font-family:Microsoft YaHei"><span style="font-size:14px"><span style="color:#4e5f70">今日最热</span></span>
                      </span>
                    </p>
                  </div>
                </div>
            ...
            <div id="smv_con_36_24" ctype="image" class="esmartMargin smartAbs " cpid="738144" cstyle="Style1" ccolor="Item0" areaId="Main" isContainer="False" pvid="" tareaId="Main" re-direction="all" daxis="All" isdeletable="True" style="height: 22px; width: 10px; left: 15px; top: 61px;z-index:13;">
              <div class="yibuFrameContent con_36_24  image_Style1  " style="overflow:visible;;">
                <div class="pic_m_t_1 image-clip-wrap" data-filltype="2" id="div_con_36_24" style="height:22px;">
                  <a class="w-image-box" target="_self" href="">
                    <img src="static/contents/sitefiles2001/10007281/images/-15017.png" alt="-4770" title="-4770" id="img_smv_con_36_24" class="">
                  </a>
                </div>
                <script type="text/javascript">
                $(function() {

                  InitImageSmv("con_36_24", "10", "22", "2");
          ...
          </div><input type='hidden' name='__RequestVerificationToken' id='token__RequestVerificationToken' value='qxZpfSSfVAUd6uLqVvG1XmlEhd5z5XgiEfyGB-rHa8ehRyOgrehXd2cfMKxxoI-sRqqwC5orLsBF5t7D6UxLyhZ13p0x9_pmRdOlBB17CG8rMxHZdFN4ZTW4eBYSosmj0' />
        </div>
      </div>
    </div>
    <div style="background-color: transparent; background-image: none; background-repeat: no-repeat; background:-moz-linear-gradient(top, none, none);background:-webkit-gradient(linear, left top, left bottom, from(none), to(none));background:-o-linear-gradient(top, none, none);background:-ms-linear-gradient(top, none, none);background:linear-gradient(top, none, none);;
