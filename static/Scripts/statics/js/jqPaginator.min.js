! function(a) {
    ...
    a.jqPaginator = function(b, c) {
        ...
        return d.$container = a(b), d.$container.data("jqPaginator", d), d.init = function() {
            (c.first || c.prev || c.next || c.last || c.page || c.before || c.after) && (c = a.extend({}, {
                first: "",
                prev: "",
                next: "",
                last: "",
            ...
            for (b > e && (b = e), f = Math.floor(b / 2), g = c - f + 1 - b % 2, h = c + f, 1 > g && (g = 1, h = b), h > e && (h = e, g = 1 + e - b), i = g; h >= i;) a.push(i), i++;
            return a
            ...
            d.$container.off(), d.$container.on("click", "[jp-role]", function() {
                var e, f, g, c = a(this);
                if (!c.hasClass(b.disableClass) && !c.hasClass(b.activeClass) && (e = c.attr("jp-role"), "before" != e && "after" != e)) {
                    if (f = +c.attr("jp-data"), "go" == e) {
                        if (g = d.$container.find("[jp-data='go']").val(), isNaN(g) || g > d.options.totalPages || 0 >= g) return d.$container.find("[jp-data='go']").val(""), void 0;
                        if (g == d.options.currentPage) return;
                        f = +g
                    } else if ("more" == e) {
                        if (g = d.options.currentPage + 1, g >= d.options.totalPages) return;
                        f = g
                    }
                    d.fireEvent(f, "change") && d.switchPage(f)
                }
            }), d.$container.on("change", "[jp-data='go']", function() {
                var b = a(this),
                    c = b.val();
                isNaN(c) && b.val("")
            }), d.$container.on("keyup", "[jp-data='go']", function(a) {
                "13" == a.keyCode && d.$container.find("[jp-role='go']").click()
            })
        }, d.init(), d.$container
        ...
        if ("string" == typeof c[0]) {
            if (d = a(b).data("jqPaginator")) return d.callMethod(c[0], c[1]);
